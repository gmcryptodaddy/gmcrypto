...
//
// Only posts from the last 24 hours are returned. If the channel is quiet
// for a day+, the news feed section will be hidden on the homepage.
...
export async function getTelegramFeed() {
  ...
  // Filter to last 24 hours only. Posts without a date are excluded
  // because we can't verify they're recent.
  ...
  return recentPosts.slice(0, MAX_POSTS)
}
