...
// Both methods combined give the best coverage.
...
export async function getTelegramFeed() {
  ...
  // Merge: bot API posts are more reliable/recent, scraped fills gaps
...
/**
 * Cleans up post text — removes [gm] branding, gmcrypto.news URLs, etc.
 */
...
async function fetchViaScraping() {
  ...
  // Check if page actually has messages (vs redirect to channel info)
